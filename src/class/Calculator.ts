    ...
    return new Promise(async (resolved, rejected) => {
      try {
        ...
        const actionrows: ActionRowBuilder<ButtonBuilder>[] = [
          new ActionRowBuilder<ButtonBuilder>().addComponents(components[0]),
          new ActionRowBuilder<ButtonBuilder>().addComponents(components[1]),
          new ActionRowBuilder<ButtonBuilder>().addComponents(components[2]),
